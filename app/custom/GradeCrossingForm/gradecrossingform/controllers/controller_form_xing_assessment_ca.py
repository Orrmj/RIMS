...
class ControllerCrossingAssessmentCA(qtw.QWidget):
    ...
    def connect_and_emit_trigger(self):
        ...
        required input variables:
            ...
            doubleSpinBox_location_of_grade_crossing_nearest_intersection_signalized_s_of_w_approach
        required methods:
            None
        '''
        ...
        self.view.doubleSpinBox_location_of_grade_crossing_nearest_intersection_signalized_s_of_w_approach.valueChanged.connect(self.model.preemption_of_traffic_signals_lookup_proximity_condition)
        ...
        self.view.doubleSpinBox_location_of_grade_crossing_nearest_intersection_signalized_s_of_w_approach.valueChanged.connect(self.model.preemption_of_traffic_signals_lookup_required)
