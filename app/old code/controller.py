...
class Controller(QObject):
    ...
    def change_input_collision_history_total_5_year_period(self):
        input_collision_history_fatal_injury = self._model.input_collision_history_total_5_year_period.value()
        input_collision_history_personal_injury = self._model.input_collision_history_total_5_year_period.value()
        input_collision_history_property_damage = self._model.input_collision_history_total_5_year_period.value()
        input_collision_history_total_5_year_period = sum(input_collision_history_fatal_injury,input_collision_history_personal_injury, input_collision_history_property_damage)
        self._model.input_collision_history_total_5_year_period.setValue(input_collision_history_total_5_year_period)
