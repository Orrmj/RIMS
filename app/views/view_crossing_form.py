...
class ViewCrossingForm(qtw.QWidget):
    ...
    def formWidgets(self):
        ...
        #Group Labels 
        #TODO input_collision_history_total_5_year_period = pass
        ...
        #TODO input_design_calculate_clearance_time_crossing_pedestrian_design_check = pass
        #TODO input_design_calculate_clearance_time_crossing_vehicle_design_check = pass
        ...
        #TODO input_design_lookup_design_vehicle_class = pass
        #TODO input_design_lookup_design_vehicle_length = pass
        ...
        # Group Labels
        #TODO input_gcws_warrant_private_9_3 = pass
        ...
        #TODO input_gcws_warrant_public_9_1 = pass
        ...
        input_gcws_warrants_comments = qtw.QTextEdit()

        # GRADE CROSSING WARNING SYSTEMS (GCS SECTION 12-16)
        #Group TextEdits
        input_gcws_comments = qtw.QTextEdit()
        ...
        #Group ComboBoxes
        input_light_units_observe_cantilevers_per_fig_12_3 = qtw.QComboBox()
        input_light_units_observe_cantilevers_per_fig_12_3.addItems(list_yes_no_na)

        input_light_units_observe_per_fig_12_1 = qtw.QComboBox()
        input_light_units_observe_per_fig_12_1.addItems(list_yes_no_na)
        ...
        #Group TextEdits
        input_preemption_of_traffic_signals_comments = qtw.QTextEdit()
        ...
        form_layout_location_of_crossing.addRow('N or E Road Approach (m):', input_location_of_grade_crossing_nearest_intersection_stop_n_or_e_approach)
        form_layout_location_of_crossing.addRow('S or W Road Approach (m):', input_location_of_grade_crossing_nearest_intersection_stop_s_of_w_approach)
        form_layout_gcws_warrants.addRow(qtw.QLabel('D (Signalized Intersection)'))
        form_layout_location_of_crossing.addRow('N or E Road Approach (m):', input_location_of_grade_crossing_nearest_intersection_signalized_n_or_e_approach)
        form_layout_location_of_crossing.addRow('S or W Road Approach (m):', input_location_of_grade_crossing_nearest_intersection_signalized_s_of_w_approach)
        form_layout_gcws_warrants.addRow(qtw.QLabel('D (Other Intersection / Driveway / Crosswalk)'))
        form_layout_location_of_crossing.addRow('N or E Road Approach (m):', input_location_of_grade_crossing_nearest_intersection_other_n_or_e_approach)
        form_layout_location_of_crossing.addRow('S or W Road Approach (m):', input_location_of_grade_crossing_nearest_intersection_other_s_of_w_approach)        
        ...
        form_layout_crossing_surface.addRow('N or E Road Approach:', input_grade_crossing_surface_measure_road_surface_travel_lanes_width_n_or_e_approach)
        form_layout_crossing_surface.addRow('S or W Road Approach:', input_grade_crossing_surface_measure_road_surface_travel_lanes_width_s_or_w_approach)
        form_layout_crossing_surface.addRow(qtw.QLabel('Paved Shoulder Width (m):'))
        form_layout_crossing_surface.addRow('N or E Rail Approach:', input_grade_crossing_surface_measure_road_surface_shoulder_n_or_e_approach)
        form_layout_crossing_surface.addRow('S or W Rail Approach:', input_grade_crossing_surface_measure_road_surface_shoulder_s_or_w_approach)
        form_layout_crossing_surface.addRow(qtw.QLabel('Surface Extension beyond Travel Lanes/Shoulder (m):'))
        form_layout_crossing_surface.addRow('N or E Rail Approach:', input_grade_crossing_surface_measure_crossing_surface_extension_n_or_e_approach)
        form_layout_crossing_surface.addRow('S or W Rail Approach:', input_grade_crossing_surface_measure_crossing_surface_extension_s_or_w_approach)
        form_layout_crossing_surface.addRow(qtw.QLabel('Sidewalk / Path / Trail Width (m):'))
        form_layout_crossing_surface.addRow('N or E Rail Approach:', input_grade_crossing_surface_measure_sidewalk_width_n_or_e_approach)
        form_layout_crossing_surface.addRow('S or W Rail Approach:', input_grade_crossing_surface_measure_sidewalk_width_s_or_w_approach)
        form_layout_crossing_surface.addRow(qtw.QLabel('Surface Extension beyond Sidewalk / Path / Trail (m):'))
        form_layout_crossing_surface.addRow('N or E Rail Approach:', input_grade_crossing_surface_measure_sidewalk_extension_n_or_e_approach)
        form_layout_crossing_surface.addRow('S or W Rail Approach:', input_grade_crossing_surface_measure_sidewalk_extension_s_or_w_approach)
        form_layout_crossing_surface.addRow(qtw.QLabel('Distance Between Travel Lane / Shoulder and Sidewalk / Path / Trail (m):'))
        form_layout_crossing_surface.addRow('N or E Rail Approach:', input_grade_crossing_surface_measure_distance_between_travel_lane_and_sidewalk_n_or_e_approach)
        form_layout_crossing_surface.addRow('S or W Rail Approach:', input_grade_crossing_surface_measure_distance_between_travel_lane_and_sidewalk_s_or_w_approach)
        form_layout_crossing_surface.addRow(qtw.QLabel('Distance from path centreline to crossing warning device (m):'))
        form_layout_crossing_surface.addRow('N or E Rail Approach:', input_grade_crossing_surface_measure_distance_between_signal_mast_and_sidewalk_n_or_e_approach)
        form_layout_crossing_surface.addRow('S or W Rail Approach:', input_grade_crossing_surface_measure_distance_between_signal_mast_and_sidewalk_s_or_w_approach)
        ...
        form_layout_road_geometry.addRow('N or E Road Approach:', input_road_geometry_observe_smooth_alignment_within_ssd_n_or_e_approach)
        form_layout_road_geometry.addRow('S or W Road Approach:', input_road_geometry_observe_smooth_alignment_within_ssd_s_or_w_approach)
        ...
        form_layout_road_geometry.addRow('N or E Road Approach:', input_road_geometry_observe_lane_width_crossing_vs_approach_n_or_e_approach)
        form_layout_road_geometry.addRow('S or W Road Approach:', input_road_geometry_observe_lane_width_crossing_vs_approach_s_or_w_approach)
        form_layout_road_geometry.addRow(qtw.QLabel('Road Approach Grades (%):'))
        form_layout_road_geometry.addRow('Within 8m (N or E Road Approach):', input_road_geometry_measure_slope_within_8m_nearest_rail_n_or_e_approach)
        form_layout_road_geometry.addRow('Within 8m (S or W Road Approach):', input_road_geometry_measure_slope_within_8m_nearest_rail_s_or_w_approach)
        form_layout_road_geometry.addRow('Between 8m to 18m (N or E Road Approach):', input_road_geometry_measure_slope_between_8m_and_18m_nearest_rail_n_or_e_approach)
        form_layout_road_geometry.addRow('Between 8m to 18m (S or W Road Approach):', input_road_geometry_measure_slope_between_8m_and_18m_nearest_rail_s_or_w_approach)
        form_layout_road_geometry.addRow('Across SSD (N or E Road Approach):', input_road_geometry_road_general_approach_grade_n_or_e_approach)
        form_layout_road_geometry.addRow('Across SSD (S or W Road Approach):', input_road_geometry_road_general_approach_grade_s_or_w_approach)
        form_layout_road_geometry.addRow('Within 5m of Sidewalk/Path/Trail (N or E Road Approach):', input_road_geometry_measure_slope_within_5m_nearest_rail_at_sidewalk_n_or_e_approach)
        form_layout_road_geometry.addRow('Within 5m of Sidewalk/Path/Trail (S or W Road Approach):', input_road_geometry_measure_slope_within_5m_nearest_rail_at_sidewalk_s_or_w_approach)
        #form_layout_road_geometry.addRow('Allowable difference between roadway gradient and railway cross-slope (%)', input_road_geometry_lookup_gradient_difference)
        form_layout_road_geometry.addRow('Railway Cross Slope (%):', input_road_geometry_measure_railway_cross_slope)
        form_layout_road_geometry.addRow('Are rail tracks super elevated? (N or E Road Approach):', input_road_geometry_rail_superelevation_n_or_e_approach)
        form_layout_road_geometry.addRow('Are rail tracks super elevated? (S or W Road Approach):', input_road_geometry_rail_superelevation_s_or_w_approach)
        form_layout_road_geometry.addRow('Is there any evidence that "low-bed" trucks have difficulty negotiating the crossing? (i.e. might they bottom-out or get stuck?)', input_road_geometry_observe_low_bed_truck_condition)
        form_layout_road_geometry.addRow('Grade Crossing Angle:', input_road_geometry_road_crossing_angle)
        form_layout_road_geometry.addRow('Road Geometry Comments:', input_road_geometry_comments)

        # layout container widgets - SIGHTLINES (GCS SECTION 7)
        #TODO form_layout_sightlines.addRow('SSD Minimum (N or E Road Approach) (m):', input_sightlines_lookup_ssd_minimum_n_or_e_approach)
        #TODO form_layout_sightlines.addRow('SSD Minimum (S or W Road Approach) (m):', input_sightlines_lookup_ssd_minimum_s_or_w_approach)
        form_layout_sightlines.addRow('SSD Actual (N or E Road Approach) (m):', input_sightlines_measure_ssd_actual_n_or_e_approach)
        form_layout_sightlines.addRow('SSD Actual (S or W Road Approach) (m):', input_sightlines_measure_ssd_actual_s_or_w_approach)
        #TODO form_layout_sightlines.addRow('DSSD Minimum (ft):', input_sightlines_calculate_Dssd_vehicle_Min_ft)
        #TODO form_layout_sightlines.addRow('DSSD Minimum (m):', input_sightlines_calculate_Dssd_vehicle_Min_m)
        form_layout_sightlines.addRow("DSSD Actual (N or E Road Approach) (Driver's Left) (m):", input_sightlines_measure_dssd_actual_n_or_e_approach_left)
        form_layout_sightlines.addRow("DSSD Actual (N or E Road Approach) (Driver's Right) (m):", input_sightlines_measure_dssd_actual_n_or_e_approach_right)
        form_layout_sightlines.addRow("DSSD Actual (S or W Road Approach) (Driver's Left) (m):", input_sightlines_measure_dssd_actual_s_or_w_approach_left)
        form_layout_sightlines.addRow("DSSD Actual (S or W Road Approach) (Driver's Right) (m):", input_sightlines_measure_dssd_actual_s_or_w_approach_right)
        #TODO form_layout_sightlines.addRow('DStopped Minimum (Vehicle) (ft):', input_sightlines_calculate_Dstopped_vehicle_Min_ft)
        #TODO form_layout_sightlines.addRow('DStopped Minimum (Vehicle) (m):', input_sightlines_calculate_Dstopped_vehicle_Min_m)
        #TODO form_layout_sightlines.addRow('DStopped Minimum (Pedestiran) (ft):', input_sightlines_calculate_Dstopped_pedestrian_Min_ft)
        #TODO form_layout_sightlines.addRow('DStopped Minimum (Pedestrian) (m):', input_sightlines_calculate_Dstopped_pedestrian_Min_m)
        form_layout_sightlines.addRow("DStopped Actual (N or E Road Approach) (Driver's Left) (m):", input_sightlines_measure_dstopped_actual_n_or_e_approach_driver_left)
        form_layout_sightlines.addRow("DStopped Actual (N or E Road Approach) (Driver's Right) (m):", input_sightlines_measure_dstopped_actual_n_or_e_approach_driver_right)
        form_layout_sightlines.addRow("DStopped Actual (S or W Road Approach) (Driver's Left) (m):", input_sightlines_measure_dstopped_actual_s_or_w_approach_driver_left)
        form_layout_sightlines.addRow("DStopped Actual (S or W Road Approach) (Driver's Right) (m):", input_sightlines_measure_dstopped_actual_s_or_w_approach_driver_right)
        form_layout_sightlines.addRow("Are there any obstacles within the sight triangles that affect visibility?", input_sightlines_observe_sightline_obstructions)
        ...
        form_layout_sightlines.addRow('Sightline Comments', input_sightlines_comments)
        ...
        #TODO form_layout_gcws_warrants.addRow("A. Where the forecast cross-product is 2,000 or more:"", input_gcws_warrant_public_9_1_a)
        #TODO form_layout_gcws_warrants.addRow("B. Where there is no sidewalk, path or trail and the railway design speed is more than 129 km/hr (80 mph);", input_gcws_warrant_public_9_1_b)
        #TODO form_layout_gcws_warrants.addRow("C. Where there is a sidewalk, path or trail and the railway design speed is more than 81 km/hr (50 mph);", input_gcws_warrant_public_9_1_c)
        ...
        #TODO form_layout_gcws_warrants.addRow("D1. Where there are two or more lines of railway where railway equipment may pass each other;", input_gcws_warrant_public_9_1_d_i)
        #TODO form_layout_gcws_warrants.addRow("D2. The distance as shown in Figure 9-1(a) between a Stop sign at an intersection and the nearest rail in the crossing surface is less than 30m;", input_gcws_warrant_public_9_1_d_ii)
        #TODO form_layout_gcws_warrants.addRow("D3. In the case of an intersection with a traffic signal, the distance between the stop line of the intersection and the nearest rail in the crossing surface, as shown in Figure 9-1(b), is less than 60m, or where there is no stop line, the distance between the travelled way and the nearest rail in the crossing surface is less than 60m.", input_gcws_warrant_public_9_1_d_iii)
        ...
        #TODO form_layout_gcws_warrants.addRow("A. Where the forecast cross-product is 2,000 or more;", input_gcws_warrant_private_9_3_1)
        form_layout_gcws_warrants.addRow(qtw.QLabel('B. Where the railway design speed is more than 25 km/hr (15mph), and;'))
        #TODO form_layout_gcws_warrants.addRow("B1. The forecast cross-product is 100 or more and there are two or more lines of railway where railway equipment may pass each other;", input_gcws_warrant_private_9_3_2_a)
        #TODO form_layout_gcws_warrants.addRow("B2. The forecast cross-product is 100 or more and grade crossing does not include a sidewalk, path or trail and the railway design speed is more than 129 km/hr (80mph);", input_gcws_warrant_private_9_3_2_b)
        #TODO form_layout_gcws_warrants.addRow("B3. The grade crossing does includes a sidewalk, path or trail and the railway design speed is more than 81 km/hr (50mph);", input_gcws_warrant_private_9_3_2_c)
        ...
        #TODO form_layout_gcws_warrants.addRow("A. The sidewalk, path or trail is outside the island circuit of an adjacent warning system and the railway design speed is more than 81 km/hr (50mph)", input_gcws_warrant_sidewalk_9_5)
        ...
        #TODO form_layout_gcws_gates.addRow("A. A warning system is required under 9.1, and;", input_gcws_warrant_public_9_1)
        #TODO form_layout_gcws_gates.addRow("B. The forecast cross-product is 50,000 or more;", input_gates_gcws_warrant_public_9_2_1_a)
        #TODO form_layout_gcws_gates.addRow("C. There are two or more lines of railway where railway equipment may pass each other;", input_gates_gcws_warrant_public_9_2_1_b)
        #TODO form_layout_gcws_gates.addRow("D. The railway design speed is more than 81 km/hr (50mph);", input_gates_gcws_warrant_public_9_2_1_c)
        #TODO form_layout_gcws_gates.addRow("E. The distance as shown in Figure 9-1(a) between a Stop sign at an intersection and the nearest rail in the crossing surface is less than 30m;", input_gates_gcws_warrant_public_9_2_1_d)
        #TODO form_layout_gcws_gates.addRow("F. In the case of an intersection with a traffic signal, the distance between the stop line of the intersection and the nearest rail in the crossing surface, as shown in Figure 9-1(b), is less than 60m, or where there is no stop line, the distance between the travelled way and the nearest rail in the crossing surface is less than 60m.", input_gates_gcws_warrant_public_9_2_1_e)
        ...
        #TODO form_layout_gcws_gates.addRow("A. A warning system is required under 9.1, and;", input_gcws_warrant_private_9_3)
        #TODO form_layout_gcws_gates.addRow("B. The forecast cross-product is 50,000 or more;", input_gates_gcws_warrant_private_9_4_1_a)
        #TODO form_layout_gcws_gates.addRow("C. There are two or more lines of railway where railway equipment may pass each other;", input_gates_gcws_warrant_private_9_4_1_b)
        #TODO form_layout_gcws_gates.addRow("D. The railway design speed is more than 81 km/hr (50mph);", input_gates_gcws_warrant_private_9_4_1_c)
        ...
        form_layout_gcws_warrants.addRow('GCWS Warrants Comments', input_gcws_warrants_comments)

        # layout container widgets - GRADE CROSSING WARNING SYSTEMS (GCS SECTION 12-16)
        #TODO form_layout_gcws.addRow('Design Approach Warning Time:', input_gcws_rail_design_approach_warning_time)
        form_layout_gcws_warrants.addRow(qtw.QLabel('Should be greatest of:'))
        #TODO form_layout_gcws.addRow("a. 20 s, unless the grade crossing clearance distance (Fig 10-1) is more than 11 m (35 ft), in which case, the 20 s must be increased by one second for each additional 3 m (10 ft), or fraction thereof;", input_gcws_rail_design_warning_time_clearance_distance)
        #TODO form_layout_gcws.addRow("b. The Departure Time for the grade crossing "design vehicle" (Article 10.3.2);", input_gcws_rail_design_warning_time_departure_time_vehicle)
        #TODO form_layout_gcws.addRow("c. The Departure Time for pedestrians, cyclists, and persons using assistive devices (Article 10.3.3);", input_gcws_rail_design_warning_time_departure_time_pedestrian)
        #TODO form_layout_gcws.addRow("d. The gate arm clearance time, plus the time to complete the gate arm descent, plus 5 seconds;", input_gcws_rail_design_warning_time_gate_arm_clearance)
        #TODO form_layout_gcws.addRow("e. The minimum warning time required for traffic signal pre-emption;", input_gcws_rail_design_warning_time_preemption)
        #TODO form_layout_gcws.addRow("f. The time for the design vehicle travelling at the design speed to travel from the stopping sight distance, as specified in article 1.2.5.2 of the Geometric Design Guide and pass completely through the clearance distance;", input_gcws_rail_design_warning_time_ssd)
        #TODO form_layout_gcws.addRow("g. Adjacent Track Interconnected Highway-Rail Grade Crossing. (add to (a), - (e))", input_gcws_rail_design_warning_time_adjacent_crossing)
        form_layout_gcws.addRow('Actual Approach Warning Time:', input_gcws_rail_crossing_warning_time_actual)
        ...
        form_layout_gcws.addRow('N or E Road Approach:', input_gcws_measure_warning_device_n_or_e_approach_distance_from_rail)
        form_layout_gcws.addRow('S or W Road Approach:', input_gcws_measure_warning_device_s_or_w_approach_distance_from_rail)
        ...
        form_layout_gcws.addRow('N or E Road Approach:', input_gcws_measure_warning_device_n_or_e_approach_distance_from_road)
        form_layout_gcws.addRow('S or W Road Approach:', input_gcws_measure_warning_device_s_or_w_approach_distance_from_road)
        form_layout_gcws.addRow(qtw.QLabel("Distance between top of foundation and surrounding ground level (max. 100 mm (4 in))"))
        form_layout_gcws.addRow('N or E Road Approach:', input_gcws_measure_warning_device_n_or_e_approach_distance_top_of_foundation)
        form_layout_gcws.addRow('S or W Road Approach:', input_gcws_measure_warning_device_s_or_w_approach_distance_top_of_foundation)
        ...
        form_layout_gcws.addRow('N or E Road Approach:', input_gcws_measure_warning_device_n_or_e_approach_slope_from_foundation)
        form_layout_gcws.addRow('S or W Road Approach:', input_gcws_measure_warning_device_s_or_w_approach_slope_from_foundation)
        form_layout_gcws.addRow(qtw.QLabel("Light units:"))
        form_layout_gcws.addRow('N or E Road Approach:', input_gcws_observe_light_units_n_or_e_approach)
        form_layout_gcws.addRow('S or W Road Approach:', input_gcws_observe_light_units_s_or_w_approach)
        form_layout_gcws.addRow('Condition:', input_gcws_observe_light_units_condition)
        form_layout_gcws.addRow(qtw.QLabel("Cantilever Lights:"))
        form_layout_gcws.addRow('N or E Road Approach:', input_gcws_observe_cantilever_lights_n_or_e_approach)
        form_layout_gcws.addRow('S or W Road Approach:', input_gcws_observe_cantilever_lights_s_or_w_approach)
        form_layout_gcws.addRow('Condition:', input_gcws_observe_cantilever_lights_condition)
        form_layout_gcws.addRow('If there is only one sidewalk, is a bell located on the adjacent assembly?', input_gcws_observe_bell_if_sidewalk)
        form_layout_gcws.addRow(qtw.QLabel("Bells:"))
        form_layout_gcws.addRow('N or E Road Approach:', input_gcws_observe_bells_n_or_e_approach)
        form_layout_gcws.addRow('S or W Road Approach:', input_gcws_observe_bells_s_or_w_approach)
        form_layout_gcws.addRow('Condition:', input_gcws_observe_bells_condition)
        form_layout_gcws.addRow(qtw.QLabel("Gates:"))
        form_layout_gcws.addRow('N or E Road Approach:', input_gcws_observe_gates_n_or_e_approach)
        form_layout_gcws.addRow('S or W Road Approach:', input_gcws_observe_gates_s_or_w_approach)
        form_layout_gcws.addRow('Condition:', input_gcws_observe_gates_condition)
        form_layout_gcws.addRow('Is crossing warning system equipped with monitoring devices that gather and retain the data and time of information (per 12.2) for a min. of 30 days?', input_gcws_rail_self_diagnostic)
        form_layout_gcws.addRow('Does crossing warning system provide consitent warning times for railway equipment regularly operating over the grade crossing?', input_gcws_observe_warning_time_consistency)
        form_layout_gcws.addRow('Where Railway Design Speed has been reduced, other than TSO, does actual Crossing Warning Time exceed 13s compared with design?', input_gcws_observe_warning_time_consistency_reduced_speed)
        form_layout_gcws.addRow('Where railway eqipment regularly stops, left standing or turnout present within limits of warning systems, are Cut-Out Circuits in place?', input_gcws_rail_cut_out_circuit_requirements)
        form_layout_gcws.addRow('If Directional Stick Circuits present, are requirments of GCS 16.4 met?', input_gcws_rail_directional_stick_circuit_requirements)
        form_layout_gcws.addRow('Limited Use Warning System without Walk Light Assembly (Y/N)? (For Private Crossing with fewer than 3 residential dwellings only)', input_gcws_observe_gcws_limited_use_without_walk_light_assembly)
        form_layout_gcws.addRow('Limited Use Warning System with Walk Light Assembly (Y/N)? (For Private Crossing and restricted access only)', input_gcws_observe_gcws_limited_use_with_walk_light_assembly)
        form_layout_gcws.addRow('GCWS Comments', input_gcws_comments)
        
        # layout container widgets - FLASHING LIGHT UNITS (GCS SECTION 13 & 14)
        form_layout_gcws_lights.addRow('Are signal assemblies as shown in Figure 12-1?', input_light_units_observe_per_fig_12_1)
        form_layout_gcws_lights.addRow(qtw.QLabel('Alignment Height (m):'))
        form_layout_gcws_lights.addRow('N or E Road Approach:', input_light_units_measure_n_or_e_approach_height)
        form_layout_gcws_lights.addRow('S or W Road Approach:', input_light_units_measure_s_or_w_approach_height)
        form_layout_gcws_lights.addRow(qtw.QLabel('Are primary light units visible for at least the minimum SSD?'))
        form_layout_gcws_lights.addRow('N or E Road Approach:', input_light_units_observe_visibility_front_lights_n_or_e_approach)
        form_layout_gcws_lights.addRow('S or W Road Approach:', input_light_units_observe_visibility_front_lights_s_or_w_approach)
        ...
        form_layout_gcws_lights.addRow('N or E Road Approach:', input_light_units_observe_supplemental_lights_n_or_e_approach)
        form_layout_gcws_lights.addRow('S or W Road Approach:', input_light_units_observe_supplemental_lights_s_or_w_approach)
        form_layout_gcws_lights.addRow(qtw.QLabel('Are back light units visible by stopped vehicles at least 15 m?'))
        form_layout_gcws_lights.addRow('N or E Road Approach:', input_light_units_observe_visibility_back_lights_n_or_e_approach)
        form_layout_gcws_lights.addRow('S or W Road Approach:', input_light_units_observe_visibility_back_lights_s_or_w_approach)
        ...
        form_layout_gcws_lights.addRow('N or E Rail Approach:', input_light_units_observe_sidewalks_n_or_e_approach)
        form_layout_gcws_lights.addRow('S or W Rail Approach:', input_light_units_observe_sidewalks_s_or_w_approach)
        form_layout_gcws_lights.addRow('Are cantilevers as shown in Figure 12-3?', input_light_units_observe_cantilevers_per_fig_12_3)
        form_layout_gcws_lights.addRow(qtw.QLabel('Distance from nearest rail (m):'))
        form_layout_gcws_lights.addRow('N or E Rail Approach:', input_light_units_measure_cantilevers_n_or_e_approach_distance_from_rail)
        form_layout_gcws_lights.addRow('S or W Rail Approach:', input_light_units_measure_cantilevers_s_or_w_approach_distance_from_rail)
        form_layout_gcws_lights.addRow(qtw.QLabel('Distance from travelled way (m):'))
        form_layout_gcws_lights.addRow('N or E Rail Approach:', input_light_units_measure_cantilevers_n_or_e_approach_distance_from_road)
        form_layout_gcws_lights.addRow('S or W Rail Approach:', input_light_units_measure_cantilevers_s_or_w_approach_distance_from_road)
        form_layout_gcws_lights.addRow(qtw.QLabel('Height (m):'))
        form_layout_gcws_lights.addRow('N or E Rail Approach:', input_light_units_measure_cantilevers_n_or_e_approach_height)
        form_layout_gcws_lights.addRow('S or W Rail Approach:', input_light_units_measure_cantilevers_s_or_w_approach_height)
        form_layout_gcws_lights.addRow(qtw.QLabel('DR (m):'))
        form_layout_gcws_lights.addRow('N or E Rail Approach:', input_light_units_measure_cantilevers_n_or_e_approach_dr)
        form_layout_gcws_lights.addRow('S or W Rail Approach:', input_light_units_measure_cantilevers_s_or_w_approach_dr)
        form_layout_gcws_lights.addRow(qtw.QLabel('DL (m):'))
        form_layout_gcws_lights.addRow('N or E Rail Approach:', input_light_units_measure_cantilevers_n_or_e_approach_dl)
        form_layout_gcws_lights.addRow('S or W Rail Approach:', input_light_units_measure_cantilevers_s_or_w_approach_dl)
        form_layout_gcws_lights.addRow('Light Unit Comments:', input_light_units_comments)

        # layout container widgets - GATES FOR GRADE CROSSING WARNING SYSTEMS (GCS SECTION 10, 12, 15)
        #TODO form_layout_gcws_gates.addRow('Gate arm delay (Recommended) (s):', input_gates_gcws_calculate_gate_arm_clearance_time_recommended)
        form_layout_gcws_gates.addRow('Gate Arm Delay Time (from Plans) (s):', input_gates_gcws_rail_gate_arm_delay_time_design)
        form_layout_gcws_gates.addRow('Gate Arm Descent Time (from Plans) (s)', input_gates_gcws_rail_gate_arm_descent_time_design)
        #TODO form_layout_gcws_gates.addRow('Inner Gate Arm Delay Time for Adjacent Track Interconnected Highway-Rail Grade Crossing (Recommended) (s)', input_gates_gcws_calculate_inner_gate_arm_delay_time_recommended)
        form_layout_gcws_gates.addRow('nner Gate Arm Delay Time for Adjacent Track Interconnected Highway-Rail Grade Crossing (from Plans) (s)', input_gates_gcws_rail_inner_gate_arm_delay_time_design)
        form_layout_gcws_gates.addRow('Measure Gate Ascent Time (Actual) (s)', input_gates_gcws_measure_gate_ascent_time)
        form_layout_gcws_gates.addRow('Measure Gate Descent Time (Actual) (s)', input_gates_gcws_measure_gate_descent_time)
        form_layout_gcws_gates.addRow('Check Gate Ascent Time (6 to 12 sec)', input_gates_gcws_observe_gate_ascent_time)
        form_layout_gcws_gates.addRow('Check Gate Descent Time (10 to 15 sec)', input_gates_gcws_observe_gate_descent_time)
        form_layout_gcws_gates.addRow('Does gate arm come to rest in the horizontal position not less than 5s before the arrival at the crossing of railway equipment?', input_gates_gcws_observe_gate_arm_rest)
        form_layout_gcws_gates.addRow('Are gates as shown in Figure 12-2?', input_gates_gcws_observe_per_fig_12_2)
        form_layout_gcws_gates.addRow(qtw.QLabel('Are strips on the gate arm 406 mm (16 in.) wide and aligned vertically?'))
        form_layout_gcws_gates.addRow('N or E Road Approach:', input_gates_gcws_observe_gate_strips_n_or_e_approach)
        form_layout_gcws_gates.addRow('S or W Road Approach:', input_gates_gcws_observe_gate_strips_s_or_w_approach)
        ...
        form_layout_gcws_gates.addRow('N or E Road Approach:', input_gates_gcws_measure_distance_between_gate_end_and_road_cl_n_or_e_approach)
        form_layout_gcws_gates.addRow('S or W Road Approach:', input_gates_gcws_measure_distance_between_gate_end_and_road_cl_s_or_w_approach)
        form_layout_gcws_gates.addRow('Gates for GCWS Comments', input_gates_gcws_comments)
        ...
        form_layout_aaws.addRow('N or E Road Approach:', input_aawd_observe_present_n_or_e_approach)
        form_layout_aaws.addRow('S or W Road Approach:', input_aawd_observe_present_s_or_w_approach)
        form_layout_aaws.addRow(qtw.QLabel('Warrants for a Prepare to Stop at Railway Crossing Sign Per GCR'))
        #TODO form_layout_aaws.addRow('A. Is the roadway classified as an expressway?', input_aawd_warrant_gcr_lookup_road_classification)
        #TODO form_layout_aaws.addRow('B. Is at least one set of front lights on the warning system not clearly visible within the stopping sight distance of at least one of the lanes of the road approach?', input_aawd_warrant_gcr_observe_sightline_obstruction)
        #TODO form_layout_aaws.addRow('C. Do weather conditions at the grade crossing repeatedly obscure the visibility of the warning system?', input_aawd_warrant_gcr_observe_environmental_condition)
        form_layout_aaws.addRow(qtw.QLabel('Warrants for a Prepare to Stop at Railway Crossing Sign Per MUTCD'))
        #TODO form_layout_aaws.addRow('D. Is the speed limit of the travelled way greater than 90 km/h?', input_aawd_warrant_mutcd_lookup_road_speed_limit_greater_than_90_km_per_hr)
        #TODO form_layout_aaws.addRow('E. Is the crossing at the bottom of a hill or downgrade of considerable length?', input_aawd_warrant_mutcd_lookup_significant_road_downgrade)
        form_layout_aaws.addRow(qtw.QLabel('Design AAWD Advance Activation Time (s):'))
        #TODO form_layout_aaws.addRow('N or E Road Approach:', input_aawd_calculate_advance_activation_time_design_n_or_e_approach)
        #TODO form_layout_aaws.addRow('S or W Road Approach:', input_aawd_calculate_advance_activation_time_design_s_or_w_approach)
        form_layout_aaws.addRow(qtw.QLabel('Recommended minimum Advance Warning Flasher Distance from Railway'))
        #TODO form_layout_aaws.addRow('N or E Road Approach:', input_aawd_calculate_distance_sign_and_stop_n_or_e_approach_recommended)
        #TODO form_layout_aaws.addRow('S or W Road Approach:', input_aawd_calculate_distance_sign_and_stop_s_or_w_approach_recommended)
        form_layout_aaws.addRow(qtw.QLabel('Actual Advance Warning Flasher Distance from Railway'))
        form_layout_aaws.addRow('N or E Road Approach:', input_aawd_measure_distance_sign_and_stop_n_or_e_approach_actual)
        form_layout_aaws.addRow('S or W Road Approach:', input_aawd_measure_distance_sign_and_stop_s_or_w_approach_actual)
        ...
        form_layout_aaws.addRow('N or E Road Approach:', input_aawd_road_aawd_sufficient_activation_time_n_or_e_approach)
        form_layout_aaws.addRow('S or W Road Approach:', input_aawd_road_aawd_sufficient_activation_time_s_or_w_approach)
        form_layout_aaws.addRow('Prepare to Stop at Railway Crossing Sign Comments', input_aawd_comments)
        ...
        #TODO form_layout_interconnection_traffic_signals.addRow('Is there less than 30m between the nearest rail of a grade crossing and the travelled way of an intersection with traffic signals?', input_preemption_of_traffic_signals_lookup_proximity_condition)
        #TODO form_layout_interconnection_traffic_signals.addRow('Is an Interconnected Traffic Signal required?', input_preemption_of_traffic_signals_lookup_required)
        form_layout_interconnection_traffic_signals.addRow(qtw.QLabel('Other Queuing Condition(s)'))
        form_layout_interconnection_traffic_signals.addRow('Is "D" insufficient such that road vehicles might queue onto the rail tracks? (I.E. less than 60 m for traffic signals; 30 m or more for a Stop sign (or 60 m or more for traffic signals) with queued traffic encroaching within 2.4 m of the nearest rail; a situation causing vehicles to routinely queue closer than 2.4 m to the nearest rail in the crossing (Example(s): Yield sign, a roundabout, a pedestrian crossing, a bikeway, or a stopped vehicle waiting to make left turn))', input_preemption_of_traffic_signals_observe_queuing_condition)
        #TODO form_layout_interconnection_traffic_signals.addRow('Are adjacent traffic signals interconnected with a grade crossing warning system?', input_preemption_of_traffic_signals_road_or_rail_crossing_preemption_type)
        form_layout_interconnection_traffic_signals.addRow('Design Preemption activation warning time required for traffic signal preemption (s):', input_preemption_of_traffic_signals_road_preemption_warning_time_design)
        form_layout_interconnection_traffic_signals.addRow('Actual Preemption activation warning time required for traffic signal preemption (s):', input_preemption_of_traffic_signals_road_preemption_warning_time_actual)
        form_layout_interconnection_traffic_signals.addRow(qtw.QLabel('Field checks:'))
        #TODO form_layout_interconnection_traffic_signals.addRow('Date of last pre-emption check?', input_preemption_of_traffic_signals_road_date_Last_preemption_check)
        form_layout_interconnection_traffic_signals.addRow('Does interconnection provide adequate time to clear traffic from the grade crossing before the arrival of railway equipment?', input_preemption_of_traffic_signals_observe_traffic_clearance_time_adequate)
        form_layout_interconnection_traffic_signals.addRow('Does interconnection prohibit road traffic from moving from the street intersection towards the grade crossing?', input_preemption_of_traffic_signals_observe_unintended_queuing_by_traffic_signals)
        form_layout_interconnection_traffic_signals.addRow('Are there known queuing issues at the tracks?', input_preemption_of_traffic_signals_observe_known_queuing_issues)
        form_layout_interconnection_traffic_signals.addRow('Are pedestrians accommodated during the pre-emption?', input_preemption_of_traffic_signals_observe_pedestrian_accommodation)
        form_layout_interconnection_traffic_signals.addRow('Have longer/slower vehicles been considered (compared to Design Vehicle)?', input_preemption_of_traffic_signals_observe_consideration_of_Longer_vehicles)       
        form_layout_interconnection_traffic_signals.addRow('Are supplemental signs needed for motorists (no right turn on red light, etc)?', input_preemption_of_traffic_signals_observe_supplemental_signage)
        form_layout_interconnection_traffic_signals.addRow('Preemption of Traffic Signals Comments', input_preemption_of_traffic_signals_comments)

        # layout container widgets - WHISTLE CESSATION (GCS SECTION Appendix D)
        form_layout_whistle_cessation.addRow('Is train whistling prohibited at this crossing?', input_areas_without_train_whistling_rail_anti_whistling_zone)
        form_layout_whistle_cessation.addRow('24 hours per day?', input_areas_without_train_whistling_rail_anti_whistling_zone_24_hrs)
        form_layout_whistle_cessation.addRow(qtw.QLabel('Requirements'))
        form_layout_whistle_cessation.addRow('Is there evidence of routine unauthorized access (trespassing) on the rail line in the area of the crossing? Comment below.', input_areas_without_train_whistling_observe_trespassing_area)
        #TODO form_layout_whistle_cessation.addRow('What is the required type of warning system as per Table D-1?', input_areas_without_train_whistling_requirements_observe_table_D1)
        #TODO form_layout_whistle_cessation.addRow('Further to Column A of Table D-1, is a crossing warning system with gates installed per GCS 9.2?', input_areas_without_train_whistling_lookup_gcs_9_2)
        #TODO form_layout_whistle_cessation.addRow('Does crossing warning system meet requirements of GCS 12-16?', input_areas_without_train_whistling_lookup_gcs_12_to_16)
        #TODO form_layout_whistle_cessation.addRow('If Stop and Proceed, is crossing equipped with FLB meeting GCS 12-16 or manually protected?', input_areas_without_train_whistling_observe_For_stop_and_proceed)       
        form_layout_whistle_cessation.addRow('Whistle Cessation Comments', input_areas_without_train_whistling_comments)
