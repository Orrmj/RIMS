...
class ViewCrossingForm(qtw.QWidget):
    ...
    def __init__(self, model, controller):
        ...
        self.lineEdit_general_info_rail_no_tracks_main.textChanged.connect(self._controller.change_input_general_info_rail_no_tracks_main)
        self.lineEdit_general_info_rail_no_tracks_other.textChanged.connect(self._controller.change_input_general_info_rail_no_tracks_other)
    ...
    def on_input_general_info_rail_no_tracks_main_changed(self, value):
        self.lineEdit_general_info_rail_no_tracks_main.setText(value)
    ...
    def formWidgets(self):
        ...
        self.lineEdit_general_info_rail_railway_design_speed = qtw.QLineEdit() 
        ...
        form_layout_general_information.addRow('Railway Design Speed, VT (mph)', self.lineEdit_general_info_rail_railway_design_speed)
